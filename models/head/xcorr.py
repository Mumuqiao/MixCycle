...
class TGA(nn.Module):
    def __init__(self, t_feature_channel, s_feature_channel):
        super(TGA, self).__init__()
        self.mlp1 = (pt_utils.Seq(s_feature_channel+t_feature_channel)
                     .conv1d(s_feature_channel, bn=True)
                     .conv1d(int(s_feature_channel / 2), bn=True)
